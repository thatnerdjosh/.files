...
before packages are loaded."
  ...
  (setq openai-base-url "https://openrouter.ai/api/v1")
  (setq erc-server "irc.libera.chat"
        erc-nick "thatnerdjosh"
        erc-user-full-name "Khun Josh"
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-link aggressive-indent all-the-icons auto-compile auto-highlight-symbol
                auto-yasnippet avy-jump-helm-line centered-cursor-mode chatgpt
                clean-aindent-mode codegpt codex-cli column-enforce-mode company
                dall-e define-word devdocs diminish dired-quick-sort disable-mouse
                dotenv-mode drag-stuff dumb-jump eat elisp-def elisp-demos
                elisp-slime-nav ellama emr erc-hl-nicks erc-image erc-social-graph
                erc-tweet erc-view-log erc-yt esh-help eshell-prompt-extras
                ...
                flycheck-package flycheck-pos-tip go-eldoc go-fill-struct
                go-gen-test go-guru go-impl go-mode go-rename go-tag godoctor
                golden-ratio google-translate gptel helm-ag helm-c-yasnippet
                ...
                llm lorem-ipsum lsp-mode lsp-origami lsp-treemacs lsp-ui macrostep
                magit-popup multi-line multi-term nameless open-junk-file openai
                org-superstar origami overseer package-lint page-break-lines
                paradox password-generator pcre2el plz plz-event-source
                plz-media-type popwin pos-tip quickrun rainbow-delimiters request
                restart-emacs reveal-in-folder shell-pop space-doc spaceline
                spacemacs-purpose-popwin spacemacs-whitespace-cleanup
                string-edit-at-point string-inflection symbol-overlay symon
                tablist tblui term-cursor terminal-here toc-org treemacs-evil
                treemacs-icons-dired treemacs-persp treemacs-projectile undo-fu
                undo-fu-session uuidgen vi-tilde-fringe volatile-highlights vundo
                wgrep winum writeroom-mode ws-butler yaml-mode yasnippet
                yasnippet-snippets)))
  (custom-set-faces
